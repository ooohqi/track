...
// var myChart1 = echarts.getInstanceByDom(document.getElementById("Profit"));
// window.addEventListener("resize",function(){
//     myChart1.resize();
// })

// Visits
var dom = document.getElementById("Visits");
var myChart = echarts.init(dom);
var app = {};
option = null;
app.title = '环形图';
...
// Customers
var dom = document.getElementById("Customers");
var myChart = echarts.init(dom);
var app = {};
option = null;
app.title = '环形图';
...
// Sales
var dom = document.getElementById("Sales");
var myChart = echarts.init(dom);
var app = {};
option = null;
app.title = '环形图';
